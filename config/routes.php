...
return [
  ...
  [ 'GET','/choose-plan', 'ChoosePlanController', 'choosePlan' ],
  [ 'GET','/subscription-payment-form/[:priceId]', 'SubscriptionPaymentFormController', 'subscriptionPaymentForm' ],
  ...
  [ 'GET','/editor', 'SketchEditorController', 'sketchEditor' ],
  ...
  [ 'POST','/sketch/[:sketchId]/restore', 'SketchRestoreController', 'sketchRestore' ],
  ...
  [ 'GET','/tutorials/[:slug]/quizzes', 'QuizzesShowController', 'quizzesShow' ],
  ...
  [ 'GET','/blog', 'BlogController@index', 'blogIndex' ],
  [ 'GET','/blog/new', 'BlogController@new', 'blogNew' ],
  [ 'POST','/blog/create', 'BlogController@create', 'blogCreate' ],
  [ 'GET','/blog/[:slug]', 'BlogController@show', 'blogShow' ],
  [ 'GET','/blog/[:slug]/edit', 'BlogController@edit', 'blogEdit' ],
  [ 'POST','/blog/[:slug]/update', 'BlogController@update', 'blogUpdate' ],
  [ 'POST','/toggle-blog-alert', 'BlogController@toggleAlert', 'blogToggleAlert' ],
  [ 'POST','/blog/comment', 'BlogController@addComment', 'blogAddComment' ],
  [ 'POST','/blog/comment/[:comment_id]/unpublish', 'BlogController@unpublishComment', 'blogUnpublishComment' ],
  ...
  [ 'GET','/payment-method-updated', 'PaymentMethodUpdatedController', 'paymentMethodUpdated' ],
  [ 'GET','/classes/teacher', 'TeacherIndexController', 'teacherIndex' ],
  [ 'GET','/classes/teacher/new', 'TeacherNewController', 'teacherNew' ],
  [ 'POST','/classes/teacher/create', 'TeacherCreateController', 'teacherCreate' ],
  [ 'GET','/classes/teacher/[:classId]', 'TeacherShowController', 'teacherShow' ],
  [ 'GET','/classes/teacher/[:classId]/edit', 'TeacherEditController', 'teacherEdit' ],
  [ 'POST','/classes/teacher/[:classId]/update', 'TeacherUpdateController', 'teacherUpdate' ],
  [ 'POST','/classes/teacher/[:classId]/archive', 'TeacherArchiveController', 'teacherArchive' ],
  [ 'POST','/classes/teacher/[:classId]/restore', 'TeacherRestoreController', 'teacherRestore' ],
  [ 'GET','/classes/teacher/[:classId]/[:personId]', 'TeacherSketchController', 'teacherSketch' ],
  [ 'GET','/classes/join/[:joinCode]', 'ClassJoinController', 'classJoin' ],
  [ 'GET','/classes/student', 'StudentIndexController', 'studentIndex' ],
];
