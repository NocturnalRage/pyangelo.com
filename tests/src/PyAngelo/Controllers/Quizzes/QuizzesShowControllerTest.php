...
class QuizzesShowControllerTest extends TestCase {
  ...
  public function testQuizzesShowWhenQuizExists() {
    ...
    $this->tutorialRepository->shouldReceive('getUncompletedTutorialQuizInfo')->once()->with($tutorialId, $personId)->andReturn($tutorialQuizInfo);
  ...
  public function testQuizzesShowWhenNoQuiz() {
    ...
    $this->auth->shouldReceive('getPersonDetailsForViews')->once()->with();
    $this->tutorialRepository->shouldReceive('getTutorialbySlug')->once()->with($slug)->andReturn($tutorial);
    $this->tutorialRepository->shouldReceive('getUncompletedTutorialQuizInfo')->once()->with($tutorialId, $personId)->andReturn();
    $this->tutorialRepository->shouldReceive('getTutorialSkills')->once()->with($tutorialId, $personId)->andReturn($skills);
