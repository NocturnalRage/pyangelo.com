...
use PyAngelo\Controllers\Sketch\SketchCanvasOnlyController;

class SketchCanvasOnlyControllerTest extends TestCase {
  protected $request;
  protected $response;
  protected $auth;
  ...
  public function setUp(): void {
    ...
    $this->controller = new SketchCanvasOnlyController (
      $this->request,
      $this->response,
      $this->auth,
  ...
  public function testClassCanBeInstantiated() {
    $this->assertSame(get_class($this->controller), 'PyAngelo\Controllers\Sketch\SketchCanvasOnlyController');
  }
  ...
  public function testWhenValidSketch() {
    ...
    $response = $this->controller->exec();
    $responseVars = $response->getVars();
    $expectedViewName = 'sketch/canvasonly.html.php';
