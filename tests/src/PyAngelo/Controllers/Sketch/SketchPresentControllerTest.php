...
use PyAngelo\Controllers\Sketch\SketchPresentController;

class SketchPresentControllerTest extends TestCase {
  public function setUp(): void {
    $this->request = new Request($GLOBALS);
    $this->response = new Response('views');
    $this->auth = Mockery::mock('PyAngelo\Auth\Auth');
    $this->sketchRepository = Mockery::mock('PyAngelo\Repositories\SketchRepository');
    $this->controller = new SketchPresentController (
      $this->request,
      $this->response,
      $this->auth,
  ...
  public function testClassCanBeInstantiated() {
    $this->assertSame(get_class($this->controller), 'PyAngelo\Controllers\Sketch\SketchPresentController');
  }
  ...
  public function testWhenValidSlug() {
    ...
    $response = $this->controller->exec();
    $responseVars = $response->getVars();
    $expectedViewName = 'sketch/present.html.php';
