          ...
          <?php if (! $singleSketch) : ?>
            <div class="form-group<?= isset($errors['lesson_sketch_id']) ? ' has-error' : ''; ?>">
              <label for="lesson_sketch_id" class="control-label">Sketch ID:</label>
              <select id="lesson_sketch_id" name="lesson_sketch_id" class="form-control">
                <option></option>
              <?php foreach ($sketches as $sketch): ?>
                <option <?php if ($sketch['sketch_id'] == ($formVars['lesson_sketch_id'] ?? '')) echo 'selected'; ?> value="<?= $this->esc($sketch['sketch_id']); ?>"><?= $this->esc($sketch['title']); ?></option>
              <?php endforeach; ?>
              </select>
                <?php if (isset($errors['lesson_sketch_id'])) :?>
                  <div class="alert alert-danger"><?= $this->esc($errors['lesson_sketch_id']); ?></div>
                <?php endif; ?>
              </div>
          <?php endif; ?>
